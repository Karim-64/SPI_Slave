...
HD_PWD='D:/Digital_Design_codes/Project_2/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_slave_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_slave_top_module.tcl -notrace
