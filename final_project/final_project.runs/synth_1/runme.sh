...
HD_PWD='D:/Digital_Design_codes/Project_2/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_slave_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_slave_top_module.tcl
