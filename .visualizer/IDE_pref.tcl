...
set perspective_DateTime   {2025-03-09T19:02:17}
set perspective_Directory  {D:/Digital_Design_codes/Project_2}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zindetails,zinlintMsgDashboardView,zinlintDesignMetricsView,zinmsgviewer,zinflownavigator,source,zinlintMsgSummaryView,zinlintDesignInfoView,source,zinlintMsgStatusHistoryView,zincdcdutview,zinlintMsgView,transcript -hide -description none -label none
